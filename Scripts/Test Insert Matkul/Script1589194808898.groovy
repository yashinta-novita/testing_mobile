...
Mobile.setText(findTestObject('Mobile_Progmob/android.widget.EditText0 (2)'), 'yashinta.novita@si.ukdw.ac.id', 0)
...
Mobile.setText(findTestObject('Mobile_Progmob/android.widget.EditText0 - Nama Mahasiswa (1)'), 'Yashinta Novita Dewi', 0)

Mobile.tap(findTestObject('Mobile_Progmob/android.widget.EditText0 - NIM Mahasiswa'), 0)

Mobile.setText(findTestObject('Mobile_Progmob/android.widget.EditText0 - NIM Mahasiswa (1)'), '72170110', 0)

Mobile.tap(findTestObject('Mobile_Progmob/android.widget.EditText0 - Alamat Mahasiswa'), 0)

Mobile.setText(findTestObject('Mobile_Progmob/android.widget.EditText0 - Alamat Mahasiswa (1)'), 'rekreasi', 0)

Mobile.tap(findTestObject('Mobile_Progmob/android.widget.EditText0 - Email Mahasiswa'), 0)

Mobile.setText(findTestObject('Mobile_Progmob/android.widget.EditText0 - Email Mahasiswa (1)'), 'yashinta.novita@si.ukdw.ac.id', 
    0)
